      ...
      <div className='content'>
        <>
          ...
          <Row>
            <Col md={12}>
              <div className='box'>
                <Image src='/images/jumbotron.png' alt='antiques' fluid />
              </div>
              <div className='box'>
                <h1>About Us</h1>
                <p>
                  ...
                  beauty of history. Our passion for antiques drives us to seek
                  out treasures that carry stories from the past.
                </p>
            ...
            <Col md={6}>
              <div className='box'>
                ...
                <p>
                  ...
                  Discover intricately carved wooden furniture and elegant stone
                  sculptures that add a touch of rustic charm to any space.
                </p>
              </div>
            </Col>
            <Col md={6}>
